...
#define MyAppName "InstagramPhotoDownloader"
#define MyAppVersion "1.0.1"
#define MyAppPublisher "dredei, http://www.softez.pp.ua/"
#define MyAppURL "http://www.softez.pp.ua/"
#define MyAppExeName "InstagramPhotoDownloader.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{C0582C36-5C61-4C76-BA61-3C492C25F24D}
AppName={#MyAppName}
...
OutputDir=bin
OutputBaseFilename=instagram_photo_downloader_setup
Compression=lzma
...
[Files]
Source: "Release\InstagramPhotoDownloader.exe"; DestDir: "{app}"; Flags: ignoreversion
